...
This is the Quasi-Adiabatic Propagator Path Integral (QuAPI) expression. Here $I$ represents the influence functional, capturing the effect of the reservoir \cite{feynman2000theory}. 
